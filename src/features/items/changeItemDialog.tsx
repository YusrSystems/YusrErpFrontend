...
export default function ChangeItemDialog({
  ...
  // 1. الضرائب
  const addTax = () =>
    handleChange({ itemTaxes: [...(formData.itemTaxes || []), new ItemTax()] });
  ...
  const updatePricingMethod = (
    index: number,
    field: keyof ItemUnitPricingMethod,
    value: any,
  ) => {
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <SelectField
                        ...
                        onValueChange={(val) =>
                          handleChange({ type: Number(val) as ItemType })
                        }
                        options={[
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <SelectField
                        ...
                        onValueChange={(val) =>
                          handleChange({ statusId: Number(val) })
                        }
                        options={[
                          { label: "مفعل", value: "1" },
              ...
              <div className="space-y-6 animate-in fade-in">
                <div className="grid grid-cols-3 gap-6">
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange({ sellUnitName: e.target.value })
                    }
                  />
                  <NumberField
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange({ taxIncluded: e.target.checked })
                    }
