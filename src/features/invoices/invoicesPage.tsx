  ...
  return (
    <CrudPage<Invoice>
      ...
      tableRowMapper={(invoice: Invoice) => [
        ...
        {
          rowName:
            invoice.statusId === InvoiceStatus.Valid ? "صالحة" : "محذوفة",
      ...
      actions={{
        ...
        openChangeDialog: (entity) =>
          InvoiceSlice.dialogActions.openChangeDialog(entity),
        openDeleteDialog: (entity) =>
          InvoiceSlice.dialogActions.openDeleteDialog(entity),
        setIsChangeDialogOpen: (open) =>
          InvoiceSlice.dialogActions.setIsChangeDialogOpen(open),
        setIsDeleteDialogOpen: (open) =>
          InvoiceSlice.dialogActions.setIsDeleteDialogOpen(open),
        refresh: InvoiceSlice.entityActions.refresh,
        setCurrentPage: (page) =>
          InvoiceSlice.entityActions.setCurrentPage(page),
      }}
      ChangeDialog={
        <ChangeInvoiceDialog
