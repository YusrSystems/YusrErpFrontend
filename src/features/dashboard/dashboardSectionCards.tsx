import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@yusr_systems/ui";
  ...
  return (
    <div className="grid grid-cols-1 gap-4 px-4 lg:px-6 sm:grid-cols-2 xl:grid-cols-4">
      { cards.map((card) => (
        <Card
          key={ card.id }
          className="@container group relative overflow-hidden border-border/40 bg-background/50 shadow-sm transition-all hover:shadow-md hover:border-border/80"
        >
