...
import {
  CommissionType,
  PaymentMethodFilterColumns,
  PaymentMethodSlice,
} from "../../core/data/paymentMethod";
...
export default function PaymentMethodsPage() {
  ...
  return (
    <CrudPage<PaymentMethod>
      ...
      tableRowMapper={(paymentMethod: PaymentMethod) => [
        { rowName: `#${paymentMethod.id}`, rowStyles: "" },
        { rowName: paymentMethod.name, rowStyles: "font-semibold" },
        {
          rowName:
            paymentMethod.accountName || paymentMethod.accountId.toString(),
          rowStyles: "",
        },
        {
          rowName:
            paymentMethod.commissionType === CommissionType.Percent
              ? "نسبة مئوية (%)"
              : "مبلغ ثابت",
      ...
      actions={{
        ...
        openChangeDialog: (entity) =>
          PaymentMethodSlice.dialogActions.openChangeDialog(entity),
        openDeleteDialog: (entity) =>
          PaymentMethodSlice.dialogActions.openDeleteDialog(entity),
        setIsChangeDialogOpen: (open) =>
          PaymentMethodSlice.dialogActions.setIsChangeDialogOpen(open),
        setIsDeleteDialogOpen: (open) =>
          PaymentMethodSlice.dialogActions.setIsDeleteDialogOpen(open),
        refresh: PaymentMethodSlice.entityActions.refresh,
        setCurrentPage: (page) =>
          PaymentMethodSlice.entityActions.setCurrentPage(page),
      }}
      ChangeDialog={
