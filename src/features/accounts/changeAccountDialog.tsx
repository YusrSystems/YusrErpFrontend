...
export default function ChangeAccountDialog({
  ...
  const { formData, handleChange, getError, isInvalid, validate } =
    useEntityForm<Account>(initialValues, validationRules);
      ...
      <div className="max-h-[75vh] overflow-y-auto px-2 pb-2">
        <FieldGroup>
          ...
          {(requiresTaxInfo || isBank) && (
            <FieldsSection
              title={
                isBank ? "المعلومات البنكية" : "المعلومات الضريبية والتجارية"
              }
              columns={2}
            >
              {requiresTaxInfo && (
                ...
                <FieldsSection title="معلومات العنوان" columns={1}>
                  <div className="flex flex-col gap-1.5 w-full">
                    ...
                    <SearchableSelect
                      ...
                      onSearch={(condition) =>
                        dispatch(filterCities(condition))
                      }
